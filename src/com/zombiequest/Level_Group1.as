...
package com.zombiequest
{
	...
	public class Level_Group1 extends Map
	{
		...
		public function addShapesForLayertext(onAddCallback:Function = null):void
		{
			...
			callbackNewData(new TextData(840.000, 3900.000, 100.000, 50.000, 0.901, "Zombie Killers closing in!  Beware!  (press space to attack)","system", 8, 0x0, "center"), onAddCallback, textGroup, generateProperties( null ) ) ;
			callbackNewData(new TextData(828.000, 2429.000, 100.000, 58.824, 0.000, "This is an innocent bystander. You can eat him to regain health, but beware the consequences.","system", 8, 0x0, "center"), onAddCallback, textGroup, generateProperties( null ) ) ;
